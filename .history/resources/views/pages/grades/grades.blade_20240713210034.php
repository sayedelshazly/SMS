            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12 mb-30">
                            ...
                            <table id="datatable" class="table table-striped table-bordered p-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $grade->Notes }}</td>
                                        <td>
                                            <button class="btn bnt-primary" type="button" data-toggle="modal" data-target="#exampleModalEdit{{$grade->id}}">
                                                {{ trans('grades.Edit') }}
                                            </button>
                        ...
                        <div class="modal fade" id="exampleModalEdit{{$grade->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <form action="#" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="Name" class="mr-sm-2">{{
                                                    ...
                                                    :</label>
                                                <input id="Name" type="text" name="Name" value="{{$grade->getTranslation('Name', 'A')}}" class="form-control"
                                                    >
                                            </div>
                                            <div class="col">
                                                <label for="Name_en" class="mr-sm-2">{{
                                                    ...
                                                    :</label>
                                                <input type="text" class="form-control" name="Name_en" value="{{$grade->Name}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="Notes"
                                                id="exampleFormControlTextarea1" rows="3">{{$grade->Notes}}</textarea>
                                        </div>
                                        <br><br>
                                </div>
