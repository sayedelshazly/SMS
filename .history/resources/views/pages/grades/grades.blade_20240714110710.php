                            ...
                            <table id="datatable" class="table table-striped table-bordered p-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $grade->Notes }}</td>
                                        <td>
                                            <button type="button" class="btn btn-info fs-4 btn-sm" data-toggle="modal"
                                    ...
                                    <div class="modal fade" id="exampleModalEdit{{$grade->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('grades.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        {{ trans('grades.Warning Grade') }}
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                            value="{{ $grade->id }}">
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">{{ trans('grades.Close')
                                                                }}</button>
                                                            <button type="submit" class="btn btn-danger">{{
                                                                trans('grades.Delete') }}</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
